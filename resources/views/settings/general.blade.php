        ...
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4 mb-5">
                        {{ Form::label('company_email', __('messages.setting.company_email').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::email('company_email', $settings['company_email'], ['class' => 'form-control ', 'required' ,'id'=>'company_email']) }}
                    </div>
                    <div class="form-group col-sm-4 mb-5">
                                ...
                                <div class="mb-3" io-image-input="true">
                                    ...
                                    <div class="d-block">
                                        <div class="image-picker">
                                            ...
                                            {{ $styleCss }}="
                                        background-image: url({{ ($settings['app_logo'] !=null) ? ($settings['app_logo']) : asset('assets/images/infyom.png') }}
                                            )">
                                        </div>
                        ...
                        <div class="mb-3" io-image-input="true">
                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    ...
                                    {{ $styleCss }}="
                                background-image: url({{ ($settings['favicon_icon'] !=null) ? ($settings['favicon_icon']) : asset('assets/images/favicon.png') }}
                                    );">
                                </div>
