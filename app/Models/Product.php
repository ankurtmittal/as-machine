...
class Product extends Model implements HasMedia
{
    ...
    protected $fillable = ['name', 'code', 'category_id', 'unit_price', 'description', 'shippingPolicy'];
    ...
    {
        return $this->hasMany(Media::class,'model_id')->where('model_type','App\Models\Product');;
    }

    public function image()
    {
        return $this->hasOne(Media::class, 'model_id')->where('model_type','App\Models\Product');
    }
