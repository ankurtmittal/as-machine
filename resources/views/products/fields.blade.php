<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::textarea('shippingPolicy',null,['class' => 'form-control ', 'placeholder' => __('messages.product.shippingPolicy')]) }}
        </div>
    </div>
        ...
        <div class="mb-3" io-image-input="true">
            ...
            <div class="d-block">
                <div class="image-picker">
                    ...
                    {{ $styleCss }}="background-image: url('{{ asset('images/default-product.jpg') }}')">
                    </div>
